SELECT 
  ...
  productVersions.id AS productVersions_id,
	productVersions.name AS productVersions_name,
...
WHERE (product.updated_at>:sql_last_value OR productVersions.updated_at>:sql_last_value)
